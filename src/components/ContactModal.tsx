  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-[#F4F3EE] w-full max-w-md rounded-3xl p-8 flex flex-col items-center shadow-2xl z-10">
        ...
        <button onClick={closeModal} className="absolute top-6 right-6 text-primary hover:opacity-70 transition-opacity">
        ...
        {submitted ? (
          <div className="text-center py-10 flex flex-col items-center">
            <div className="w-16 h-16 bg-[#A38A76]/20 rounded-full flex items-center justify-center mx-auto mb-6">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
            </div>
            <p className="text-primary font-medium text-lg leading-relaxed">
              Espero tu mensaje por WhatsApp para que chismeemos y trabajemos juntos en esa mejor versión.
            </p>
          </div>
        ) : (
          <>
            <div className="relative w-35 h-20 mb-4">
              <Image src="/assets/logo_3.png" alt="Kittyfits" fill className="object-contain" />
            </div>

            <h3 className="text-2xl font-bold text-primary text-center leading-tight mb-8">
              Cuéntame el chisme,<br />¿en qué te puedo ayudar?
            </h3>

            <form onSubmit={handleSubmit} className="w-full flex flex-col gap-5">
              <div className="flex flex-col gap-2">
                <label className="text-primary font-bold text-[15px]">Nombre</label>
                <input
                  type="text"
                  required
              ...
              <div className="flex flex-col gap-2">
                <label className="text-primary font-bold text-[15px]">De qué país o ciudad me escribes?</label>
                <input
                  type="text"
                  required
              ...
              <div className="flex flex-col gap-2">
                <label className="text-primary font-bold text-[15px]">En qué estás interesado?</label>
              ...
              <div className="flex flex-col gap-2">
                <label className="text-primary font-bold text-[15px]">Cómo me conociste?</label>
                <div className="relative w-full">
                  <select
                    value={source}
              ...
              <button type="submit" className="w-full bg-[#A38A76] text-[#F4F3EE] font-bold text-lg rounded-2xl py-4 mt-2 hover:bg-opacity-90 transition-all shadow-md">
